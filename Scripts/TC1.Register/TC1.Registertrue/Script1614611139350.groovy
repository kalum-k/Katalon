...
WebUI.setText(findTestObject('Object Repository/Page_/input__card_id'), '1730501138456')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_/select_-                                   _e88667'), 
    'นางสาว', true)

WebUI.setText(findTestObject('Object Repository/Page_/input__fname'), 'ศุภาดา')

WebUI.setText(findTestObject('Object Repository/Page_/input__lname'), 'ทองไทย')
...
WebUI.setText(findTestObject('Object Repository/Page_/input_Facebook_facebook'), 'hna')

WebUI.setText(findTestObject('Object Repository/Page_/input_Email_email'), 'hna@mail.com')

WebUI.setText(findTestObject('Object Repository/Page_/input__student_id'), '614259054')
...
WebUI.verifyTextPresent('614259054', false)
